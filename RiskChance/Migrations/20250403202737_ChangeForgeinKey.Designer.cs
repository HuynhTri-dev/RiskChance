...
namespace RiskChance.Migrations
{
    ...
    [Migration("20250403202737_ChangeForgeinKey")]
    partial class ChangeForgeinKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RiskChance.Models.AccessLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RiskChance.Models.HopDongDauTu", b =>
                {
                    ...
                    b.Property<string>("MinhChungThanhToan")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RiskChance.Models.ThanhToanLoiNhuan", b =>
                {
                    ...
                    b.Property<string>("MinhChungFile")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RiskChance.Models.AccessLog", b =>
                {
                    b.HasOne("RiskChance.Models.NguoiDung", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
